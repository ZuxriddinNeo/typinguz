[![](https://github.com/typeuz/typeuz/blob/master/frontend/static/images/githubbanner2.png?raw=true)](https://typeuz.uz/)
<br />
...
TypeUZ is a minimalistic and customizable [typing test](https://www.typeuz.uz). It features many test modes, an account system to save your typing speed history, and user-configurable features such as themes, sounds, a smooth caret, and more. TypeUZ attempts to emulate a natural typing experience during a typing test by unobtrusively presenting the text prompts and displaying typed characters in place, providing straightforward, real-time feedback on typos, speed, and accuracy.
...
On the [TypeUZ Discord server](https://www.discord.gg/typeuz), we added a Discord bot to auto-assign optional roles based on typing performance and challenge completion. You can find its code over at https://github.com/typeuz/typeuz-bot.
...
All of the [contributors](https://github.com/typeuz/typeuz/graphs/contributors) have helped implement various features, add themes, fix bugs, and more.

# Support

If you wish to support further development and feel extra awesome, you can [donate](https://ko-fi.com/typeuz), [become a Patron](https://www.patreon.com/typeuz), or [buy a t-shirt](https://www.typeuz.store/).
