...
export type UpdateProfileDetailsRequest = z.infer<typeof UpdateProfileDetailsRequestSchema>;

export const WeeklyAnalysisDailyBreakdownSchema = z.object({
  date: z.string(),
  wpm: z.number(),
  accuracy: z.number(),
  tests: z.number(),
});
export type WeeklyAnalysisDailyBreakdown = z.infer<
  typeof WeeklyAnalysisDailyBreakdownSchema
>;

export const WeeklyAnalysisResponseSchema = responseWithData(
  z.object({
    avgWpm: z.number(),
    ...
    bestWpm: z.number(),
    bestWpmDate: z.string(),
    trend: z.enum(["improving", "declining", "stable"]),
    bestDay: z.string(),
    dailyBreakdown: z.array(WeeklyAnalysisDailyBreakdownSchema),
    recommendation: z.string(),
  }),
);
export type WeeklyAnalysisResponse = z.infer<
  typeof WeeklyAnalysisResponseSchema
>;
...
export const usersContract = c.router(
  {
    ...
    updateProfileDetails: {
      ...
      description: "Update profile details (firstName, lastName, gender, age, avatar)",
      method: "PATCH",
    ...
    getWeeklyAnalysis: {
      ...
      description:
        "Get AI-powered weekly analysis of the user's typing performance",
      method: "GET",
      path: "/weekly-analysis",
      responses: {
        200: WeeklyAnalysisResponseSchema,
      },
      metadata: meta({
        rateLimit: "userGet",
      }),
