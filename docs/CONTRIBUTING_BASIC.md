...
This file details how to create basic contributions to TypeUZ purely through the use of GitHub's web UI. This means you will not need to set up a local development environment of any kind; all you'll need is a browser that can access GitHub and a GitHub account.
...
First, you will have to obtain your own copy of the TypeUZ repository, also known as "forking". Click [here](https://github.com/typeuz/typeuz/fork) to open the fork wizard or go to the top right of your screen and then click the `fork` button.
...
This will create a clone of the repository under your own account. Navigate to your profile now and click on the new repository called `typeuz` under your profile.
...
Be sure to add a good description to the PR and that the source and destination branches at the top look correct. The `base repository` and `base branch` should be listed as `typeuz/typeuz` and `master` respectively, and on the right of that should be your forked repository and the branch you have your changes on.
