...
If the language is not rendered correctly, you can provide a `preferredFont`. The font needs to be one of typeuzs fonts. Check the [fonts documentation](./FONTS.md).
...
Once you have created your language, you now need to create a pull request to the main TypeUZ repository. Go to the branch where you created your languages on GitHub. Then make sure your branch is up to date. Once it is up to date, click "contribute".
